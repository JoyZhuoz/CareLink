...
- **Patient Cards**: Beautifully designed cards showing:
  - Patient information with profile photos
  - Operation details
  - Recent symptoms
  - AI-generated summaries for urgent cases
  - Color-coded urgency levels (Urgent, Monitor, Minimal)
- **Tab Navigation**: Switch between Patients and Analytics views
